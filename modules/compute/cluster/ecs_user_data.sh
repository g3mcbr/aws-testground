...
#aws s3 cp s3://tf-up-and-running-state/dev/elktest/config/master/ossec.conf /wazuh/master/etc
#aws s3 cp s3://tf-up-and-running-state/dev/elktest/config/slave1/ossec.conf /wazuh/slave1/etc
#aws s3 cp s3://tf-up-and-running-state/dev/elktest/config/slave2/ossec.conf /wazuh/slave2/etc
